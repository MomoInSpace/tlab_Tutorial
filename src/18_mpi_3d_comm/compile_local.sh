...
# Start of script ========================================
export gpu_profile="$HOME/Coding/tlab_Tutorial/src/18_mpi_3d_comm"
cd $gpu_profile
mkdir build -p 
cd build
...
mpif90 $gpu_profile/tlab_constants.f90 $gpu_profile/tlab_arrays.f90 $gpu_profile/grid_utils.f90 $gpu_profile/program_comm_test.f90 -o comm_test.o
