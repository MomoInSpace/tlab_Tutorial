...
mpifort $gpu_profile/tlab_constants.f90 $gpu_profile/tlab_arrays.f90 $gpu_profile/grid_utils.f90 $gpu_profile/grid_handler.f90 $gpu_profile/compgrid_handler.f90 $gpu_profile/program_comm_test.f90 -acc=gpu -target=gpu -gpu=lineinfo,cc80 -cpp -g -O0 -o comm_test.o
