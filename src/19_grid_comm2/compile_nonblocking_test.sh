...
mpifort $gpu_profile/tlab_constants.f90 $gpu_profile/tlab_arrays.f90 $gpu_profile/grid_handler.f90 $gpu_profile/grid_communicator.f90 $gpu_profile/grid_debug.f90  $gpu_profile/program_nonblockingtest.f90 -acc=gpu -target=gpu -gpu=lineinfo,cc80 -cpp -g -O0 -o para_test.o
